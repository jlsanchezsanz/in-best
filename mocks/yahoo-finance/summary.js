...
export const dataSummary = `
  ...
  >
        ...
        <tbody>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            ...
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="PREV_CLOSE-value">
              <span class="Trsdu(0.3s)">129.52</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>Open</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="OPEN-value">
              <span class="Trsdu(0.3s)">130.85</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>Bid</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="BID-value">
              <span class="Trsdu(0.3s)">130.48 x 1300</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>Ask</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="ASK-value">
              <span class="Trsdu(0.3s)">130.25 x 1800</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>Day's Range</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="DAYS_RANGE-value">129.48 - 131.26</td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
          ...
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            ...
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="TD_VOLUME-value">
              <span class="Trsdu(0.3s)">74,667,644</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px) Bdbw(0)!">
            <td class="C($primaryColor) W(51%)"><span>Avg. Volume</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="AVERAGE_VOLUME_3MONTH-value">
              <span class="Trsdu(0.3s)">101,889,137</span>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div
      ...
      data-test="right-summary-table"
    >
      <table class="W(100%) M(0) Bdcl(c)">
        <tbody>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>Market Cap</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="MARKET_CAP-value">
              <span class="Trsdu(0.3s)">2.173T</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>Beta (5Y Monthly)</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="BETA_5Y-value">
              <span class="Trsdu(0.3s)">1.20</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>PE Ratio (TTM)</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="PE_RATIO-value">
              <span class="Trsdu(0.3s)">29.27</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>EPS (TTM)</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="EPS_RATIO-value">
              <span class="Trsdu(0.3s)">4.45</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>Earnings Date</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="EARNINGS_DATE-value">
              <span>Jul 27, 2021</span
              ><!-- react-text: 1352 -->
              -
              <!-- /react-text --><span>Aug 01, 2021</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>Forward Dividend &amp; Yield</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="DIVIDEND_AND_YIELD-value">
              0.88 (0.68%)
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px)">
            <td class="C($primaryColor) W(51%)"><span>Ex-Dividend Date</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="EX_DIVIDEND_DATE-value">
              <span>May 06, 2021</span>
            </td>
          </tr>
          <tr class="Bxz(bb) Bdbw(1px) Bdbs(s) Bdc($seperatorColor) H(36px) Bdbw(0)!">
            <td class="C($primaryColor) W(51%)"><span>1y Target Est</span></td>
            <td class="Ta(end) Fw(600) Lh(14px)" data-test="ONE_YEAR_TARGET_PRICE-value">
              <span class="Trsdu(0.3s)">158.58</span>
            </td>
          </tr>
        </tbody>
      </table>
