import { scrapeFreeCashFlow, scrapeRevenue, scrapeEPS } from '../scraping';

describe('scraping utils', () => {
  describe('scrapeRevenue', () => {
    const data = `
  ...
  `;
    ...
    it('should return revenue object', () => {
      ...
      const result = scrapeRevenue(data, 10);
  ...
  describe('scrapeEPS', () => {
    ...
    it('should return EPS object', () => {
      ...
      const result = scrapeEPS(data, 10);

      expect(result).toEqual(expectedEPS);
    });
  });

  describe('scrapeFreeCashFlow', () => {
    const data = `
      <table class="historical_data_table table">
        <tbody>
    ...
    it('should return Book Value Per Share object', () => {
      ...
      const result = scrapeFreeCashFlow(data, 10);
